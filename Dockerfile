...
# Deleting Visual Studio build artifacts (otherwise the build will failed)
RUN dotnet clean -c Debug
RUN dotnet clean -c Release
RUN rm -rf $MICROSVC_NAME/bin
RUN rm -rf $MICROSVC_NAME/obj/Debug
RUN rm -rf $MICROSVC_NAME/obj/Release
# Let's go!
